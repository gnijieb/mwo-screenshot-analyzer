    ...
    if count >= 1:
        ...
        with Image.open(file1) as img:
            ...
            while row < 24:
                ...
                # player
                draw.rectangle(
                    (resinfo.player.x1, y1, resinfo.player.x2, y2), outline=col)

                # mech
                draw.rectangle(
                    (resinfo.mech.x1, y1, resinfo.mech.x2, y2), outline=col)

                # status
                draw.rectangle(
                    (resinfo.status.x1, y1, resinfo.status.x2, y2), outline=col)

                # match score
                draw.rectangle(
                    (resinfo.score.x1, y1, resinfo.score.x2, y2), outline=col)

                # kills
                draw.rectangle(
                    (resinfo.kills.x1, y1, resinfo.kills.x2, y2), outline=col)

                # assists
                draw.rectangle(
                    (resinfo.assists.x1, y1, resinfo.assists.x2, y2), outline=col)

                # damage
                draw.rectangle(
                    (resinfo.damage.x1, y1, resinfo.damage.x2, y2), outline=col)
